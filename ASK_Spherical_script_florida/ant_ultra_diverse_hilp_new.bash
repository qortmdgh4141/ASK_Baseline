...
for ((i=start; i<=end_; i++)); do
    python ${main_py_path} --gpu ${gpu} --save_dir ${bash_script_path} --run_group ant_ultra_diverse_${extra_name}_${current_time} --env_name antmaze-ultra-diverse-v0 --project ${project} --seed $((i*100)) --algo_name ask_hilp --pretrain_steps 1000002 --eval_interval 50000 --save_interval 100000 --eval_episodes 6 --num_video_episodes 24 --way_steps 50 \
