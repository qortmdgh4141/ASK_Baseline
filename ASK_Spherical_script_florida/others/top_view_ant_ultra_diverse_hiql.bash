...
use_rep=hiql_goal_encoder                      # ["hiql_goal_encoder", "hilp_subgoal_encoder", "hilp_encoder", "vae_encoder"]
...
for ((i = start; i <= end_; i++)); do
    python ${main_py_path} --gpu ${gpu} --save_dir ${bash_script_path} --run_group topview-ant_ultra_diverse_${extra_name}_${current_time} --env_name topview-antmaze-large-diverse-v2 --project ${project} \
        --seed $((i * 100)) --pretrain_steps 1000002 --eval_interval 50000 --save_interval 100000 --eval_episodes 6 --num_video_episodes 24 --way_steps 25 \
        --sparse_data 0 --expert_data_On 0 \
        --spherical_On 0 --rep_type concat \
        ...
        --relative_dist_in_eval_On 0 --mapping_method nearest --visual 1 --value_function_num ${value_function_num} # --model_base_path ${model_base_path} \
