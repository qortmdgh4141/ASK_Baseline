...
for ((i = start; i <= end_; i++)); do
    python ${main_py_path} --gpu ${gpu} --save_dir ${bash_script_path} --run_group FetchPush_${extra_name}_${current_time} --env_name FetchPush-v1-mixed --project ${project} \
