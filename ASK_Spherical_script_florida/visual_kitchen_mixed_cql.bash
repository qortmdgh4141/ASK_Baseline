...
for ((i=start; i<=end_; i++)); do
    python ${main_py_path} --gpu ${gpu} --save_dir ${bash_script_path} --run_group visual_Kitchen_${extra_name}_${current_time} --env_name visual-kitchen-mixed-v0 --project ${project} --seed $((i*100)) --algo_name cql --pretrain_steps 500002 --eval_interval 50000 --save_interval 100000 --eval_episodes 24 --num_video_episodes 6 --way_steps 25 --sparse_data 0 --expert_data_On 0 \
