...
project="visual-kitchen"

extra_name="ask_v_kitchen"
...
low_dim_clustering="tsne_2" # [tsne_dim, pca_dim, ''] ex) hilp_2 : hilp - 2dim, pca_2 : pca - 2dim
...
for ((i = start; i <= end_; i++)); do
    python ${main_py_path} --gpu ${gpu} --save_dir ${bash_script_path} --run_group Kitchen_${extra_name}_${current_time} --env_name visual-kitchen-mixed-v0 --project ${project} \
        --seed $((i * 100)) --pretrain_steps 500002 --eval_interval 25000 --save_interval 100000 --eval_episodes 6 --num_video_episodes 24 --way_steps 25 \
        ...
        --build_keynode_time during_training --keynode_num 300 --kmean_weight_On 1 --use_goal_info_On 0 --kmean_weight_type rtg_uniform --specific_dim_On 0 --keynode_ratio 0.0 --use_keynode_in_eval_On 1 \
