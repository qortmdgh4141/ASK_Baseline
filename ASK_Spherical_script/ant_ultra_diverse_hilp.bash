...
for ((i=start; i<=end_; i++)); do
    ...
    --seed $((i*100)) --pretrain_steps 1000002 --eval_interval 50000 --save_interval 100000 --eval_episodes 6 --num_video_episodes 24 --way_steps 35 \
    --sparse_data 0 --expert_data_On 0 \
    --spherical_On 1.0 --rep_type concat \
    --mapping_threshold 0.0 --rep_normalizing_On 1 --rep_dim 10 --hilp_skill_dim 32 --build_keynode_time during_training --keynode_num 200 --kmean_weight_On 0 --use_goal_info_On 0 --kmean_weight_type rtg_uniform --specific_dim_On 1 --keynode_ratio 0.0 --use_keynode_in_eval_On 1 \
    --relative_dist_in_eval_On 0 --mapping_method nearest --kl_loss ${kl_loss}
done
