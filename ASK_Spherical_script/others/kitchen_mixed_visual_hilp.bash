...
for ((i = start; i <= end_; i++)); do
    python ${main_py_path} --gpu ${gpu} --save_dir ${bash_script_path} --run_group Kitchen_${extra_name}_${current_time} --env_name visual-kitchen-mixed-v0 --project ${project} \
        --seed $((i * 100)) --pretrain_steps 500002 --eval_interval 50000 --save_interval 100000 --eval_episodes 6 --num_video_episodes 24 --way_steps 25 \
        --sparse_data 0 --expert_data_On 0 \
        --spherical_On 1 --rep_type state \
        --mapping_threshold 99 \
        --use_rep ${use_rep} --rep_normalizing_On 0 --rep_dim 10 --hilp_skill_dim 32 --keynode_dim 10 \
        ...
        --value_function_num ${value_function_num} --visual 1
