...
# extra_name="identify_train_retry"
extra_name="hiql_35"
...
for ((i = start; i <= end_; i++)); do
    python ${main_py_path} --gpu ${gpu} --save_dir ${bash_script_path} --run_group ant_ultra_diverse_${extra_name}_${current_time} --env_name antmaze-ultra-diverse-v0 --project ${project} \
        --seed $((i * 100)) --pretrain_steps 1000002 --eval_interval 100000 --save_interval 100000 --eval_episodes 6 --num_video_episodes 24 --algo_name ask --way_steps 35 \
        ...
        --relative_dist_in_eval_On 0 --mapping_method nearest --value_function_num ${value_function_num} --pseudo_obs ${pseudo_obs} --identify ${identify} # --model_base_path ${model_base_path} \
