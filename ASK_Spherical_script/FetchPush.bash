...
for ((i = start; i <= end_; i++)); do
    python ${main_py_path} --gpu ${gpu} --save_dir ${bash_script_path} --run_group FetchPush_${extra_name}_${current_time} --env_name FetchPush-v1 --project ${project} \
        ...
        --build_keynode_time during_training --keynode_num 300 --kmean_weight_On 1 --use_goal_info_On 1 --kmean_weight_type rtg_uniform --specific_dim_On 0 --keynode_ratio 0.0 --use_keynode_in_eval_On 0 \
