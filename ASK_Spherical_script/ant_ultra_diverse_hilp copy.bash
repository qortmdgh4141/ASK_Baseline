...
for ((i=start; i<=end_; i++)); do
    ...
    --mapping_threshold 0.0 --rep_normalizing_On 1 --rep_dim 10 --hilp_skill_dim 32 --keynode_dim 200 \
    --build_keynode_time during_training --keynode_num 10 --kmean_weight_On 0 --use_goal_info_On 0 --kmean_weight_type rtg_uniform --specific_dim_On 1 --keynode_ratio 0.0 --use_keynode_in_eval_On 1 \
